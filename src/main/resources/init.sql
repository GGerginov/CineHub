...
INSERT INTO address (city_name, street)
VALUES ('Sofia', 'Vitosha Boulevard 1'),
...
INSERT INTO cinema (name, slug, address_id)
VALUES ('Sofia Cinema 1', 'sofia-cinema-1',
        (SELECT id FROM address WHERE city_name = 'Sofia' and street = 'Okolovrasten pat')),
       ('Sofia Cinema 2', 'sofia-cinema-2',
        (SELECT id FROM address WHERE city_name = 'Sofia' and street = 'Vitosha Boulevard 1')),
       ('Plovdiv Cinema 1', 'plovdiv-cinema-1',
        (SELECT id FROM address WHERE city_name = 'Plovdiv' and street = 'Knyaz Alexander I')),
       ('Varna Cinema 1', 'varna-cinema-1',
        (SELECT id FROM address WHERE city_name = 'Varna' and street = 'Boulevard Knyaz Boris I')),
       ('Aprilci Cinema 1', 'aprilci-cinema-1',
        (SELECT id FROM address WHERE city_name = 'Aprilci' and street = 'Vasil Levski'));



INSERT INTO movie (title, description, duration)
VALUES ('Adventure Land', 'A thrilling adventure movie', 120),
...
INSERT INTO room (capacity, room_number, cinema_id)
VALUES (50, 1, (SELECT id FROM cinema WHERE slug = 'sofia-cinema-1')),
...
INSERT INTO show_time (start_time, end_time, movie_id, room_id)
VALUES
-- Room 1 in Sofia Cinema 1
(CURRENT_DATE + INTERVAL '1 day' + MAKE_TIME(12, 0, 0), CURRENT_DATE + MAKE_TIME(14, 0, 0),
 (SELECT id FROM movie WHERE title = 'Adventure Land'),
 (SELECT id FROM room WHERE room_number = 1 AND cinema_id = (SELECT id FROM cinema WHERE slug = 'sofia-cinema-1'))),
(CURRENT_DATE + INTERVAL '1 day' + MAKE_TIME(15, 0, 0), CURRENT_DATE + MAKE_TIME(17, 0, 0),
 (SELECT id FROM movie WHERE title = 'Space Warriors'),
 (SELECT id FROM room WHERE room_number = 1 AND cinema_id = (SELECT id FROM cinema WHERE slug = 'sofia-cinema-1'))),

-- Room 2 in Sofia Cinema 1
(CURRENT_DATE + INTERVAL '1 day' + MAKE_TIME(12, 0, 0), CURRENT_DATE + MAKE_TIME(14, 0, 0),
 (SELECT id FROM movie WHERE title = 'Love in Paris'),
 (SELECT id FROM room WHERE room_number = 2 AND cinema_id = (SELECT id FROM cinema WHERE slug = 'sofia-cinema-1'))),
(CURRENT_DATE + INTERVAL '1 day' + MAKE_TIME(15, 0, 0), CURRENT_DATE + MAKE_TIME(17, 0, 0),
 (SELECT id FROM movie WHERE title = 'The Unknown Detective'),
 (SELECT id FROM room WHERE room_number = 2 AND cinema_id = (SELECT id FROM cinema WHERE slug = 'sofia-cinema-1'))),

-- Room 1 in Plovdiv Cinema 1
(CURRENT_DATE + INTERVAL '1 day' + MAKE_TIME(12, 0, 0), CURRENT_DATE + MAKE_TIME(14, 0, 0),
 (SELECT id FROM movie WHERE title = 'Adventure Land'),
 (SELECT id FROM room WHERE room_number = 1 AND cinema_id = (SELECT id FROM cinema WHERE slug = 'plovdiv-cinema-1'))),
(CURRENT_DATE + INTERVAL '1 day' + MAKE_TIME(15, 0, 0), CURRENT_DATE + MAKE_TIME(17, 0, 0),
 (SELECT id FROM movie WHERE title = 'Space Warriors'),
 (SELECT id FROM room WHERE room_number = 1 AND cinema_id = (SELECT id FROM cinema WHERE slug = 'plovdiv-cinema-1'))),
...
(CURRENT_DATE + INTERVAL '1 day' + MAKE_TIME(12, 0, 0), CURRENT_DATE + MAKE_TIME(14, 0, 0),
 (SELECT id FROM movie WHERE title = 'Love in Paris'),
 (SELECT id FROM room WHERE room_number = 1 AND cinema_id = (SELECT id FROM cinema WHERE slug = 'varna-cinema-1'))),
(CURRENT_DATE + INTERVAL '1 day' + MAKE_TIME(15, 0, 0), CURRENT_DATE + MAKE_TIME(17, 0, 0),
 (SELECT id FROM movie WHERE title = 'The Unknown Detective'),
 (SELECT id FROM room WHERE room_number = 1 AND cinema_id = (SELECT id FROM cinema WHERE slug = 'varna-cinema-1'))),
...
(CURRENT_DATE + INTERVAL '1 day' + MAKE_TIME(12, 0, 0), CURRENT_DATE + MAKE_TIME(14, 0, 0),
 (SELECT id FROM movie WHERE title = 'Adventure Land'),
 (SELECT id FROM room WHERE room_number = 1 AND cinema_id = (SELECT id FROM cinema WHERE slug = 'aprilci-cinema-1'))),
(CURRENT_DATE + INTERVAL '1 day' + MAKE_TIME(15, 0, 0), CURRENT_DATE + MAKE_TIME(17, 0, 0),
 (SELECT id FROM movie WHERE title = 'Space Warriors'),
 (SELECT id FROM room WHERE room_number = 1 AND cinema_id = (SELECT id FROM cinema WHERE slug = 'aprilci-cinema-1'))),

-- Another Room in Sofia Cinema 1 for variety
(CURRENT_DATE + INTERVAL '1 day' + MAKE_TIME(12, 0, 0), CURRENT_DATE + MAKE_TIME(13, 30, 0),
 (SELECT id FROM movie WHERE title = 'Love in Paris'),
 (SELECT id FROM room WHERE room_number = 3 AND cinema_id = (SELECT id FROM cinema WHERE slug = 'sofia-cinema-1'))),
(CURRENT_DATE + INTERVAL '1 day' + MAKE_TIME(14, 0, 0), CURRENT_DATE + MAKE_TIME(15, 30, 0),
 (SELECT id FROM movie WHERE title = 'The Unknown Detective'),
 (SELECT id FROM room WHERE room_number = 3 AND cinema_id = (SELECT id FROM cinema WHERE slug = 'sofia-cinema-1')));
...
SELECT 10.0,      -- Fixed price for all tickets
